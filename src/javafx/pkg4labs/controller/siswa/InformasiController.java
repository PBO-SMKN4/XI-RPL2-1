...
public class InformasiController implements Initializable {
    ...
    public void showData(){
        ...
        for (InfoTugasBerita berita : listBerita) {
            ...
            href.getStyleClass().add("link");
            href.getStylesheets().add("..\\..\\css\\informasi.css");
    ...
    @FXML
    public void search(){
        String keyword = inp_query.getText();        
        if (keyword == null ) {
