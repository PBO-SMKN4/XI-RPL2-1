...
public class CurhatController implements Initializable {
    ...
    public void showChat(){
        ...
        masukan.setStyle("-fx-control-inner-background:#FAFAD2; -fx-pref-height:50; -fx-pref-width:283; -fx-max-width:285; -fx-font-family: Times; -fx-font-size:18; -fx-border-radius: 10%;");
