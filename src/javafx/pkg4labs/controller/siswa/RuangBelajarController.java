 ...
 */
public class RuangBelajarController implements Initializable {
    ...
    @FXML
    private void rumus(javafx.scene.input.MouseEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/javafx/pkg4labs/view/siswa/Rumus.fxml"));
        Node node = (Node) event.getSource();
    ...
    @FXML
    private void ruangDiskusi(javafx.scene.input.MouseEvent event) throws IOException {
